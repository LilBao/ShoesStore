			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form modelAttribute="productDetail" method="post"
								enctype="multipart/form-data">
								<a href="${pageContext.request.contextPath}/index/product/editDetail/${prdid}"
						                class="btn btn-secondary mb-3"><i class="bi bi-sign-turn-left"></i>Turn Back</a>
								<form:input path="id" cssClass="form-control" hidden="hidden" />
								<div class="row mb-3">
									<label for="inputEmail3" class="col-sm-2 col-form-label">Product
										Id:</label>
									<div class="col-sm-10">
										<form:input path="products.id" class="form-control" hidden="hidden"/>
										<form:input path="products.name" class="form-control" readonly="true"/>
									</div>
								</div>
								<div class="row mb-3">
								...
								<div class="row mb-3 justify-content-between">
									...
									<form:checkboxes path="size" items="${listSize}"
										cssClass="form-control text-center " />
								</div>
								<a href="${pageContext.request.contextPath }/index/product/cleanImg/${id}">Clear images</a>
								<div class="d-flex">
									<label for="inputEmail3" class="col-sm-2 col-form-label">Image:</label>
									<div class="d-flex flex-wrap">
										<c:forEach var="item" items="${listImages }">
										<img class="img-thumbnail w-25 my-1" alt=""
													src="${pageContext.request.contextPath }/img/${item}">
									</c:forEach>
									</div>
								</div>
								<input hidden="hidden" name="imgStr" value="${imgStr }">
								<div class="d-flex ">
									<label for="inputEmail3" class="col-sm-2 col-form-label">Additional Image:</label>
									<input type="file" multiple="multiple" name="image">
								</div>
								<button
									formaction="${pageContext.request.contextPath}/index/product/information/saveDetail"
									class="btn btn-success  mt-3">
									<i class="bi bi-save"></i> Save
								</button>
								<button
									formaction="${pageContext.request.contextPath}/index/product/deleteDetail/${id}"
