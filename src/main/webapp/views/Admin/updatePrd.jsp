						...
						<div class="card-body">
							<form:form
								...
								<div class="d-flex justify-content-between">
									<a href="${pageContext.request.contextPath}/index/product" class="btn btn-secondary mb-3"><i class="bi bi-sign-turn-left"></i>Turn Back</a>
									<a href="${pageContext.request.contextPath}/index/product/editDetail/${id}" class="btn btn-secondary mb-3"><i class="bi bi-sign-turn-right"></i>Information Detail</a>
								</div>
								...
								<button formaction="${pageContext.request.contextPath}/index/product/information/saveBasic" class="btn btn-success  mt-3">
									<i class="bi bi-save"></i> Save
								</button>
								<button
									formaction="${pageContext.request.contextPath}/index/product/delete/${id}"
