		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<a href="${pageContext.request.contextPath}/index/user"
						class="btn btn-secondary mb-3"><i class="bi bi-sign-turn-left"></i>Back</a>
					<!-- Page Heading -->
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<form:form modelAttribute="user" method="POST">
								<form:input path="id" hidden="hidden" cssClass="form-control" />
								<form:input path="password" hidden="hidden" cssClass="form-control" />
								<div class="row mb-3">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<form:select class="form-control" selected="selected" path="admin">
								...
								<button
									formaction="${pageContext.request.contextPath}/index/user/save"
									class="btn btn-success  mt-3">
									<i class="bi bi-save"></i>Save
								</button>
								<a
									href="${pageContext.request.contextPath}/index/user/remove/${id}"
